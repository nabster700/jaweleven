<a style="color: #6b6e84;font-size: 0.8rem;text-decoration: none !important;" href="{link}">
  <div class="card hov w-100 list-group-item-action">
      <div class="list-group-item list-group-item-action p-1">
        <div class="media position-relative">
          <a href="{link}" class="stretched-link">
        [xfgiven_poster]<img src="[xfvalue_image_url_poster]" class="rounded mr-2" alt="{title}" style="width:70px;">[/xfgiven_poster]
